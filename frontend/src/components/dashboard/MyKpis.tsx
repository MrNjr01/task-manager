...
export function MyKpis() {
  ...
  if (loading) return <div className="grid grid-cols-2 lg:grid-cols-5 gap-4"><div className="h-24 border rounded-lg animate-pulse" /></div>;
  if (!data) return null;
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
      ...
      <KpiCard title="Redelegated" value={data.redelegated} icon={Repeat} color="bg-purple-100 text-purple-600 dark:bg-purple-900 dark:text-purple-300" />
    </div>
  );
}
